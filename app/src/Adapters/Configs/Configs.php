...
class Configs
{
    ...
    private function __construct(IliasRestApiClient $iliasRestApiClient)
    {
        ...
        $this->contexts['courseList'] = function (int $parentRefId): array {
        ...
        $this->projectTo['keyValueList'] = function (callable $publish): callable {
            return function (array $objectList) use ($publish) {
                Adapters\ProjectionTypes\KeyValueList::new()->project($objectList, $publish);
            };
        };
    }
    ...
    public function data(string $contextType, string $parentIdOrId): array
    {
